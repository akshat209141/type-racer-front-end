...
const products = [
  { name: 'Practice Typing', description: 'Practice and improvise your typing skills',href:"#", icon: ChartPieIcon },
  { name: 'Play with Others', description: 'Play and compete with random enthusiastic peolpe like you ',icon: CursorArrowRaysIcon },
  { name: 'Play with Friends', description: 'Wanna, have some fun with your Friends! We Got You',icon: CursorArrowRaysIcon },
]
const callsToAction = [
